...
const page = () => {
  return (
    ...
    <BatteryPageHero src={'/assets/images/battery/EP-650-24.jpg'} type={'Automative'} model={'EP 650'} rating={'65 Ah'} dimensions={'Length: 26.5 Width: 17.5 Height: 22'} weight={'15.5'} warranty={'24 (12*+12)'} applications={'Used for Auto rickshaw, Ape rickshaw, cars, transport vehicles like Tata Ace etc'} />
    </>
  )
}
